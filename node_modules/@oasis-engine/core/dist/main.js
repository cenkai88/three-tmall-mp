...
var BoxColliderShape = /*#__PURE__*/function (_ColliderShape) {
  ...
  function BoxColliderShape() {
    ...
    _this._size = new math.Vector3(1, 1, 1);
...
var PlaneColliderShape = /*#__PURE__*/function (_ColliderShape) {
  ...
  function PlaneColliderShape() {
    ...
    _this = _ColliderShape.call(this) || this;
    _this._rotation = new math.Vector3();
...
var PointerManager = /*#__PURE__*/function () {
  ...
  function PointerManager(engine) {
    ...
    this._currentPosition = new math.Vector2();
...
PointerManager._tempRay = new math.Ray();
PointerManager._tempPoint = new math.Vector2();
    ...
    if (value.r !== undefined) {
      if (cacheValue.x !== value.r || cacheValue.y !== value.g) {
        if (this._colorSpace === exports.ColorSpace.Linear) {
          this._gl.uniform2f(shaderUniform.location, math.Color.gammaToLinearSpace(value.r), math.Color.gammaToLinearSpace(value.g));
        } else {
  ...
  _proto.upload3f = function upload3f(shaderUniform, value) {
    ...
    if (value.r !== undefined) {
      if (cacheValue.x !== value.r || cacheValue.y !== value.g || cacheValue.z !== value.b) {
        if (this._colorSpace === exports.ColorSpace.Linear) {
          this._gl.uniform3f(shaderUniform.location, math.Color.gammaToLinearSpace(value.r), math.Color.gammaToLinearSpace(value.g), math.Color.gammaToLinearSpace(value.b));
        } else {
  ...
  _proto.upload4f = function upload4f(shaderUniform, value) {
    ...
    if (value.r !== undefined) {
      if (cacheValue.x !== value.r || cacheValue.y !== value.g || cacheValue.z !== value.b || cacheValue.w !== value.a) {
        if (this._colorSpace === exports.ColorSpace.Linear) {
          this._gl.uniform4f(shaderUniform.location, math.Color.gammaToLinearSpace(value.r), math.Color.gammaToLinearSpace(value.g), math.Color.gammaToLinearSpace(value.b), value.a);
        } else {
...
var PrimitiveMesh = /*#__PURE__*/function () {
  ...
  PrimitiveMesh.createPlane = function createPlane(engine, width, height, horizontalSegments, verticalSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      positions[i] = new math.Vector3(x * gridWidth - halfWidth, 0, z * gridHeight - halfHeight); // Normal

      normals[i] = new math.Vector3(0, 1, 0); // Texcoord

      uvs[i] = new math.Vector2(x * horizontalSegmentsReciprocal, z * verticalSegmentsReciprocal);
    }
  ...
  PrimitiveMesh.createCapsule = function createCapsule(engine, radius, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < torsoVertexCount; ++i) {
      ...
      var sinTheta = Math.sin(theta);
      var cosTheta = Math.cos(theta);
      positions[i] = new math.Vector3(radius * sinTheta, y * unitHeight - halfHeight, radius * cosTheta);
      normals[i] = new math.Vector3(sinTheta, 0, cosTheta);
      uvs[i] = new math.Vector2(u, 1 - v);
    }
  ...
  PrimitiveMesh._createCapsuleCap = function _createCapsuleCap(radius, height, radialSegments, capAlphaRange, offset, posIndex, positions, normals, uvs, indices, indicesOffset) {
    ...
    for (var i = 0; i < capVertexCount; ++i) {
      ...
      var index = i + offset;
      positions[index] = new math.Vector3(posX, posY, posZ);
      normals[index] = new math.Vector3(posX, posY, posZ);
      uvs[index] = new math.Vector2(u, v);
    }
...
var Background = /*#__PURE__*/function () {
  ...
  _proto._createPlane = function _createPlane(engine) {
    ...
    for (var i = 0; i < 4; ++i) {
      positions[i] = new math.Vector3();
      uvs[i] = new math.Vector2(i % 2, 1 - (i * 0.5 | 0));
    }
...
var SkyBoxMaterial = /*#__PURE__*/function (_Material) {
  ...
  function SkyBoxMaterial(engine) {
    ...
    _this._decodeParam = new math.Vector4(0, 5, 0, 0);
