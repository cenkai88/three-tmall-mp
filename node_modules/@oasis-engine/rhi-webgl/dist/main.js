...
var GLTexture = /*#__PURE__*/function () {
  ...
  _proto._getPixelBuffer = function _getPixelBuffer(face, x, y, width, height, mipLevel, out) {
    ...
    if (mipLevel > 0 && !this._isWebGL2) {
      mipLevel = 0;
      core.Logger.error("mipLevel only take effect in WebGL2.0");
    }
...
var GLRenderTarget = /*#__PURE__*/function () {
  ...
  _proto.setRenderTargetInfo = function setRenderTargetInfo(faceIndex, mipLevel) {
    ...
    if (colorTexture) {
      var isCube = colorTexture.isCube;

      if (mipChanged || isCube) {
        gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, isCube ? gl.TEXTURE_CUBE_MAP_POSITIVE_X + faceIndex : gl.TEXTURE_2D,
        /** @ts-ignore */
    ...
    if (depthTexture) {
      var _isCube = depthTexture.isCube;
    ...
    this._curMipLevel = mipLevel; // revert current activated render target
...
var WebGLEngine = /*#__PURE__*/function (_Engine) {
   ...
   */
  function WebGLEngine(canvas, physics, webGLRendererOptions) {
    ...
    return _Engine.call(this, webCanvas, hardwareRenderer, physics) || this;
  }
  /**
   * Web canvas.
   */
