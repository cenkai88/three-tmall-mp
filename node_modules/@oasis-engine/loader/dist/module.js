import { resourceLoader, AssetType, AssetPromise, Loader, VertexElement, IndexFormat, VertexElementFormat, AnimationClip, AnimationCurve, InterpolableKeyframe, InterpolationType, SkinnedMeshRenderer, Transform, Entity, PBRMaterial, RenderFace, BlendShape, ModelMesh, BlinnPhongMaterial, Camera, MeshRenderer, Animator, AnimatorController, AnimatorControllerLayer, AnimatorStateMachine, Skin, TextureWrapMode as TextureWrapMode$1, Texture2D, Logger, EngineObject, TextureFormat, TextureCubeMap, TextureCubeFace, SpriteAtlas, Sprite, AmbientLight, DiffuseMode, DirectLight, PointLight, SpotLight, PBRSpecularMaterial, UnlitMaterial, Component, PrimitiveMesh, AnimatorStateTransition, GLCapabilityType, Texture, SphereColliderShape, PlaneColliderShape, CapsuleColliderShape, ColliderShapeUpAxis, BoxColliderShape, DynamicCollider, SkyBoxMaterial, ObjectValues, EventDispatcher } from '@oasis-engine/core';
...
(_dec$k = resourceLoader(AssetType.Buffer, ["bin", "r3bin"], false), _dec$k(_class$k = /*#__PURE__*/function (_Loader) {
...
var _dec$j, _class$j;
(_dec$j = resourceLoader(AssetType.Prefab, ["gltf", "glb"]), _dec$j(_class$j = /*#__PURE__*/function (_Loader) {
...
var _dec$i, _class$i;
(_dec$i = resourceLoader(AssetType.JSON, ["json"], false), _dec$i(_class$i = /*#__PURE__*/function (_Loader) {
...
var _dec$h, _class$h;
(_dec$h = resourceLoader(AssetType.KTXCube, []), _dec$h(_class$h = /*#__PURE__*/function (_Loader) {
...
var _dec$g, _class$g;
(_dec$g = resourceLoader(AssetType.KTX, ["ktx"]), _dec$g(_class$g = /*#__PURE__*/function (_Loader) {
...
var _dec$f, _class$f;
(_dec$f = resourceLoader(AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$f(_class$f = /*#__PURE__*/function (_Loader) {
...
var _dec$e, _class$e;
(_dec$e = resourceLoader(AssetType.TextureCube, [""]), _dec$e(_class$e = /*#__PURE__*/function (_Loader) {
...
var _dec$d, _class$d;
(_dec$d = resourceLoader(AssetType.SpriteAtlas, ["atlas"], false), _dec$d(_class$d = /*#__PURE__*/function (_Loader) {
...
var _dec$c, _class$c;
(_dec$c = resourceLoader(AssetType.Env, ["env"]), _dec$c(_class$c = /*#__PURE__*/function (_Loader) {
  ...
  _proto.load = function load(item, resourceManager) {
    return new AssetPromise(function (resolve, reject) {
      resourceManager.load({
        ...
        var texture = new TextureCubeMap(resourceManager.engine, size);
...
function colliderConfigure(collider, props) {
  ...
  for (var i = 0; i < shapes.length; i++) {
    ...
    switch (shape._shapes) {
      ...
      case "CapsuleColliderShape":
        {
          var capsule = new CapsuleColliderShape();
      ...
      case "PlaneColliderShape":
        {
          var plane = new PlaneColliderShape();
      ...
      case "SphereColliderShape":
        {
          var sphere = new SphereColliderShape();
  ...
  if (collider instanceof DynamicCollider) {
    ...
    if (force) {
      collider.applyForce(new Vector3(force[0], force[1], force[2]));
    }

    var torque = props.torque;

    if (torque) {
      collider.applyTorque(new Vector3(torque[0], torque[1], torque[2]));
    }
  }
}
