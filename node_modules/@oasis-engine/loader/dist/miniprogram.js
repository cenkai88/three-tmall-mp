...
(_dec$k = miniprogram.resourceLoader(miniprogram.AssetType.Buffer, ["bin", "r3bin"], false), _dec$k(_class$k = /*#__PURE__*/function (_Loader) {
...
var GLTFUtil = /*#__PURE__*/function () {
  ...
  GLTFUtil.floatBufferToColorArray = function floatBufferToColorArray(buffer, isColor3) {
    ...
    if (isColor3) {
      for (var i = 0; i < bufferLen; i += 3) {
        colors[i / 3] = new miniprogram$1.Color(buffer[i], buffer[i + 1], buffer[i + 2], 1.0);
      }
    } else {
...
var _dec$j, _class$j;
(_dec$j = miniprogram.resourceLoader(miniprogram.AssetType.Prefab, ["gltf", "glb"]), _dec$j(_class$j = /*#__PURE__*/function (_Loader) {
...
var _dec$i, _class$i;
(_dec$i = miniprogram.resourceLoader(miniprogram.AssetType.JSON, ["json"], false), _dec$i(_class$i = /*#__PURE__*/function (_Loader) {
...
var _dec$h, _class$h;
(_dec$h = miniprogram.resourceLoader(miniprogram.AssetType.KTXCube, []), _dec$h(_class$h = /*#__PURE__*/function (_Loader) {
...
var _dec$g, _class$g;
(_dec$g = miniprogram.resourceLoader(miniprogram.AssetType.KTX, ["ktx"]), _dec$g(_class$g = /*#__PURE__*/function (_Loader) {
...
var _dec$f, _class$f;
(_dec$f = miniprogram.resourceLoader(miniprogram.AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$f(_class$f = /*#__PURE__*/function (_Loader) {
...
var _dec$e, _class$e;
(_dec$e = miniprogram.resourceLoader(miniprogram.AssetType.TextureCube, [""]), _dec$e(_class$e = /*#__PURE__*/function (_Loader) {
...
var _dec$d, _class$d;
(_dec$d = miniprogram.resourceLoader(miniprogram.AssetType.SpriteAtlas, ["atlas"], false), _dec$d(_class$d = /*#__PURE__*/function (_Loader) {
...
var _dec$c, _class$c;
(_dec$c = miniprogram.resourceLoader(miniprogram.AssetType.Env, ["env"]), _dec$c(_class$c = /*#__PURE__*/function (_Loader) {
  ...
  _proto.load = function load(item, resourceManager) {
    return new miniprogram.AssetPromise(function (resolve, reject) {
      resourceManager.load({
        ...
        var texture = new miniprogram.TextureCubeMap(resourceManager.engine, size);
...
var AmbientLightResource = /*#__PURE__*/function (_SchemaResource) {
  ...
  _proto.load = function load(resourceManager, assetConfig, oasis) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      resourceManager.load({
        url: url,
        type: miniprogram.AssetType.Env
      }).then(function (res) {
        _this._resource = res;
        resolve(_this);
      }).catch(function (e) {
...
function colliderConfigure(collider, props) {
  ...
  for (var i = 0; i < shapes.length; i++) {
    ...
    switch (shape._shapes) {
      case "BoxColliderShape":
        {
          var box = new miniprogram.BoxColliderShape();
      ...
      case "CapsuleColliderShape":
        {
          var capsule = new miniprogram.CapsuleColliderShape();
          ...
          if (shape.upAxis) {
            switch (shape.upAxis) {
              case "X":
                capsule.upAxis = miniprogram.ColliderShapeUpAxis.X;
                break;

              case "Y":
                capsule.upAxis = miniprogram.ColliderShapeUpAxis.Y;
                break;

              case "Z":
                capsule.upAxis = miniprogram.ColliderShapeUpAxis.Z;
                break;
            }
          }
      ...
      case "PlaneColliderShape":
        {
          var plane = new miniprogram.PlaneColliderShape();
      ...
      case "SphereColliderShape":
        {
          var sphere = new miniprogram.SphereColliderShape();
  ...
  if (collider instanceof miniprogram.DynamicCollider) {
    var force = props.force;

    if (force) {
      collider.applyForce(new miniprogram$1.Vector3(force[0], force[1], force[2]));
    }

    var torque = props.torque;

    if (torque) {
      collider.applyTorque(new miniprogram$1.Vector3(torque[0], torque[1], torque[2]));
    }
  }
}
...
var AbilityManager = (_dec$4 = pluginHook({
  ...
  _proto.add = function add(abilityConfig) {
    ...
    if (!AbilityConstructor) {
      miniprogram.Logger.error(type + " ability is not defined");
      return;
    }
  ...
  _proto.setProp = function setProp(field, key, prop) {
    ...
    if (field === "background" && key === "skyboxTexture") {
      ...
      if (prop && prop.type === "asset") {
        ...
        scene.ambientLight.diffuseMode = miniprogram.DiffuseMode.SphericalHarmonics;
        scene.ambientLight.specularTextureDecodeRGBM = true;
      } else {
        scene.ambientLight.specularTexture = null;
        scene.ambientLight.diffuseMode = miniprogram.DiffuseMode.SolidColor;
      }
    } else if (scene[field]) {
      if (prop && prop.type === "asset") {
