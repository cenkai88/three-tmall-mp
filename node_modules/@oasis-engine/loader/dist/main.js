...
(_dec$k = core.resourceLoader(core.AssetType.Buffer, ["bin", "r3bin"], false), _dec$k(_class$k = /*#__PURE__*/function (_Loader) {
...
var GLTFUtil = /*#__PURE__*/function () {
  ...
  GLTFUtil.floatBufferToColorArray = function floatBufferToColorArray(buffer, isColor3) {
    ...
    if (isColor3) {
      for (var i = 0; i < bufferLen; i += 3) {
        colors[i / 3] = new math.Color(buffer[i], buffer[i + 1], buffer[i + 2], 1.0);
      }
    } else {
      for (var _i = 0; _i < bufferLen; _i += 4) {
        colors[_i / 4] = new math.Color(buffer[_i], buffer[_i + 1], buffer[_i + 2], buffer[_i + 3]);
      }
    }
...
var _dec$j, _class$j;
(_dec$j = core.resourceLoader(core.AssetType.Prefab, ["gltf", "glb"]), _dec$j(_class$j = /*#__PURE__*/function (_Loader) {
...
var _dec$i, _class$i;
(_dec$i = core.resourceLoader(core.AssetType.JSON, ["json"], false), _dec$i(_class$i = /*#__PURE__*/function (_Loader) {
...
var _dec$h, _class$h;
(_dec$h = core.resourceLoader(core.AssetType.KTXCube, []), _dec$h(_class$h = /*#__PURE__*/function (_Loader) {
...
var _dec$g, _class$g;
(_dec$g = core.resourceLoader(core.AssetType.KTX, ["ktx"]), _dec$g(_class$g = /*#__PURE__*/function (_Loader) {
...
var _dec$f, _class$f;
(_dec$f = core.resourceLoader(core.AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$f(_class$f = /*#__PURE__*/function (_Loader) {
...
var _dec$e, _class$e;
(_dec$e = core.resourceLoader(core.AssetType.TextureCube, [""]), _dec$e(_class$e = /*#__PURE__*/function (_Loader) {
...
var _dec$d, _class$d;
(_dec$d = core.resourceLoader(core.AssetType.SpriteAtlas, ["atlas"], false), _dec$d(_class$d = /*#__PURE__*/function (_Loader) {
...
var _dec$c, _class$c;
(_dec$c = core.resourceLoader(core.AssetType.Env, ["env"]), _dec$c(_class$c = /*#__PURE__*/function (_Loader) {
  ...
  _proto.load = function load(item, resourceManager) {
    return new core.AssetPromise(function (resolve, reject) {
      resourceManager.load({
        ...
        var texture = new core.TextureCubeMap(resourceManager.engine, size);
        ...
        for (var mipLevel = 0; mipLevel < mipmapCount; mipLevel++) {
          ...
          for (var face = 0; face < 6; face++) {
            ...
            offset += dataSize;
            texture.setPixelBuffer(core.TextureCubeFace.PositiveX + face, data, mipLevel);
          }
        }

        var ambientLight = new core.AmbientLight();
        var sh = new math.SphericalHarmonics3();
        ambientLight.diffuseMode = core.DiffuseMode.SphericalHarmonics;
  ...
  _proto._playDefaultState = function _playDefaultState() {
    ...
    if (animatorController) {
      ...
      for (var i = 0, length = layers.length; i < length; ++i) {
        var _layers$i, _layers$i$stateMachin, _this$_controllerUpda3;

        //@ts-ignore
        var defaultState = (_layers$i = layers[i]) === null || _layers$i === void 0 ? void 0 : (_layers$i$stateMachin = _layers$i.stateMachine) === null || _layers$i$stateMachin === void 0 ? void 0 : _layers$i$stateMachin._defaultState;
...
var AmbientLightResource = /*#__PURE__*/function (_SchemaResource) {
  _inheritsLoose(AmbientLightResource, _SchemaResource);

  function AmbientLightResource() {
    return _SchemaResource.apply(this, arguments) || this;
  }

  var _proto = AmbientLightResource.prototype;
  ...
  return AmbientLightResource;
}(SchemaResource);

function colliderConfigure(collider, props) {
  collider.isShowCollider = props.isShowCollider;
  var shapes = props.colliderShapes;
  ...
  for (var i = 0; i < shapes.length; i++) {
    ...
    switch (shape._shapes) {
      case "BoxColliderShape":
        {
          var box = new core.BoxColliderShape();
      ...
      case "CapsuleColliderShape":
        {
          var capsule = new core.CapsuleColliderShape();
          ...
          if (shape.upAxis) {
            switch (shape.upAxis) {
              case "X":
                capsule.upAxis = core.ColliderShapeUpAxis.X;
                break;

              case "Y":
                capsule.upAxis = core.ColliderShapeUpAxis.Y;
                break;

              case "Z":
                capsule.upAxis = core.ColliderShapeUpAxis.Z;
                break;
            }
          }
      ...
      case "PlaneColliderShape":
        {
          var plane = new core.PlaneColliderShape();
      ...
      case "SphereColliderShape":
        {
          var sphere = new core.SphereColliderShape();
  ...
  if (collider instanceof core.DynamicCollider) {
    var force = props.force;

    if (force) {
      collider.applyForce(new math.Vector3(force[0], force[1], force[2]));
    }

    var torque = props.torque;

    if (torque) {
      collider.applyTorque(new math.Vector3(torque[0], torque[1], torque[2]));
    }
  }
}
...
var AbilityManager = (_dec$4 = pluginHook({
  ...
  _proto.add = function add(abilityConfig) {
    ...
    if (!AbilityConstructor) {
      core.Logger.error(type + " ability is not defined");
      return;
    }
    ...
    if (type === "GLTFModel") {
      ...
      colliderConfigure(ability, abilityProps);
    } else {
  ...
  _proto.setProp = function setProp(field, key, prop) {
    ...
    if (field === "background" && key === "skyboxTexture") {
      ...
      if (prop && prop.type === "asset") {
        var ambientLight = this.oasis.resourceManager.get(prop.id).resource;
        ...
        scene.ambientLight.diffuseMode = core.DiffuseMode.SphericalHarmonics;
        scene.ambientLight.specularTextureDecodeRGBM = true;
      } else {
        scene.ambientLight.specularTexture = null;
        scene.ambientLight.diffuseMode = core.DiffuseMode.SolidColor;
      }
    } else if (scene[field]) {
      if (prop && prop.type === "asset") {
