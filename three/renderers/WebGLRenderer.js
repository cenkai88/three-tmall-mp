...
function WebGLRenderer(parameters = {}) {
  ...
  this.gammaFactor = 2.2; // for backwards compatibility
  ...
  this.renderBufferDirect = function(
    ...
    if (index !== null) {
    //  if (object.name==='mesh_10') console.log(index)
    ...
    if (object.isInstancedMesh) {
      ...
      // if (object.name==='mesh_10') console.log(drawStart, drawCount)
      renderer.render(drawStart, drawCount, object.name==='mesh_10');
    }
  };
